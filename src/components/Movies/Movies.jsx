...
async function getmovies(){
    let response=await axios.get("https://api.themoviedb.org/3/movie/now_playing",options)
...
<div className="min-vh-100 bg-black">
    ...
    {movies.map((movie)=><Link to={`/details/movie/${movie.id}`} key={movie.id} className="col-md-3 text-decoration-none">
...
<div className="mt-2 px-2">
    <h6 className="text-white">{movie.original_title?movie.original_title:<h6 className= "text-danger">Not Found Name</h6>}</h6>
